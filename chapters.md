...
useImperativeHandle
    ...
    - createPortal
    - connects two elements which of the first is the element and the second is the location element to be displayed Implemented result page of a timer. The method of prompting result page is called in higher-level component where its lower component defines method behavior and decides location of resul page to 
...
Redux Thunk middleware
    ...
    - intercepts dispatched action
        ...
        - ifyou dispatch a function, Redux Thunk calls that function and passes dispatch and getState as arguments to the function
